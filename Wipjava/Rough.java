...
public class Rough {
    public static void main(String[] args) {
        ...
        // int
        // arr[]={45,76,34,65,123,54,78,98,12,56,78,43,67,1,54,34,78,98,99,87,90,85,82};
        // finding min and max
        // int n=arr.length;
        // int max=0,min=arr[0];
        // for(int temp:arr){
    ...
    // public static int Generate(int input1, int input2, int input3, int input4){
    // int od=input2-input1;
    // int ed=input3-input2;
    // if(input4<4){
    // if(input4==1)
    // return input1;
    // if(input4==2)
    ...
    // int temp=input4-3;
    // if(temp%2!=0){
    // return input3+od*((temp/2)+1)+ed*(temp/2);
    // }
    // else{
    // return input3+od*(temp/2)+ed*(temp/2);
    // }
